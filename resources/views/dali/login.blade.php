...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Página de inicio de sesión de DALI">
...
<div class="log">
<div class="header">
  	<h2 class="justificado">Login now!</h2>
</div>
<form action="/login" method="POST" class="registro">
	@csrf
	<h1 class="h3 mb-4 font-weight-normal justificado ">Iniciar Sesión</h1>
	...
	<a class="btn btn-primary btn-block mt-3" href="<?= route("web.gLogin"); ?>" role="button"><i class="fab fa-google"></i> | Ingresar con Google</a>
	<hr>
	<p class= justificado>¿Olvidaste tu contraseña? <a href="<?= route("web.forgot"); ?>">Recupera la contraseña</a></p>
	<p class= justificado>¿No tienes una cuenta? <a href="<?= route("web.register"); ?>">Registrate</a></p>
